...
<body>
<div class="main">
    <form class="create-main" action="/php-tutorial/create.php" method="post">
      <h3>CREATE USER:</h3>
    ...
    <table class="read-main">
      ...
      <?php while($results = mysqli_fetch_array($sqlAccounts)) { ?>
        <tr>
          ...
          <td>
            <form action="/php-tutorial/update.php" method="post">
            ...
            <form action="/php-tutorial/delete.php" method="post">
